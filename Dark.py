...
def wa():
    os.system('xdg-open https://api.whatsapp.com/send?phone=6285727675917&text=Assalamualaikum')
...
if sandi == 'Pradana15' and user == 'TERMUX':
